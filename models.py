...
class Experience(database.Model):
    ...
    area_e = database.Column(database.Enum('Pasante','Junior','Semi-Senior','Senior','Supervisor','Superintendente','Gerente-Presidente','Gerente-Presidente','Otro'),nullable=True)
    possition = database.Column(database.String(100),nullable=True)
