...
class ExperienceForm(Form):
    ...
    area_e = SelectField('Área de Trabajo:',
                                    choices=[('Pasante','Pasante'),('Junior','Junior'),('Semi-Senior','Semi-Senior'),('Senior','Senior'),('Supervisor','Supervisor'),('Superintendente','Superintendente'),('Gerente-Presidente','Gerente-Presidente')])
...
class UExperienceForm(Form):
    company = StringField('Empresa donde trabajó:')
    area_e = SelectField('Área de Trabajo:',
                                    choices=[('Pasante','Pasante'),('Junior','Junior'),('Semi-Senior','Semi-Senior'),('Senior','Senior'),('Supervisor','Supervisor'),('Superintendente','Superintendente'),('Gerente-Presidente','Gerente-Presidente'),('Otro','Otro')])
    possition = StringField('Cargo desempeñado:')
    start_date_e = DateField('Fecha de Inicio:', format='%Y-%m-%d', validators=(validators.DataRequired('Ingrese una fecha'),))
    end_date_e = DateField('Fecha de Culminación:', format='%Y-%m-%d', validators=(validators.DataRequired('Ingrese una fecha'),))
    time_e = IntegerField('Años de experiencia:', render_kw={"placeholder": "AÑOS"})
...
class FiltroForm(Form):
    ...
    area_t = SelectField(label= "Nivel de Instrucción", choices=[('Todas', 'Seleccione el tipo'),('Pasante','Pasante'),('Junior','Junior'),('Semi-Senior','Semi-Senior'),('Senior','Senior'),('Supervisor','Supervisor'),('Superintendente','Superintendente'),('Gerente-Presidente','Gerente-Presidente'),('Otro','Otro')])
